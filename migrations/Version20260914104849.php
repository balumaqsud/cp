 ...
 */
final class Version20260914104849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD locale VARCHAR(10) NOT NULL');
        $this->addSql('ALTER TABLE users ADD theme VARCHAR(20) NOT NULL');
    }
